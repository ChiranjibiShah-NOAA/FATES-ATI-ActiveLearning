...
parser.add_argument('--start_iter', default=119500, type=int,
...
def main():
    ...
    for i in range(cfg['num_cycles']):
        if cfg['name'] == 'VOC':
            ...
            list_iter = ['100000', '110000', '120000']
            list_weights = []
            ...
            for loop in list_weights:
                ...
                net.eval()
                test_dataset = VOCDetection(args.voc_root, [('2007', 'test')], BaseTransform(512, MEANS), VOCAnnotationTransform())
                mean_ap = test_net(args.eval_save_folder, net, args.cuda,
                                   test_dataset, BaseTransform(512, MEANS),
