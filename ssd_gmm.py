...
class SSD_GMM(nn.Module):
    ...
    def __init__(self, phase, size, base, extras, head, num_classes):
        ...
        if(size==300):
            self.cfg = (coco, voc300)[num_classes == 145]
        else:
            self.cfg = (coco, voc512)[num_classes == 145]
        ...
        #self.cbam = CBAM(gate_channels=512, reduction_ratio=16, pool_types=['avg', 'max'], no_spatial=False)  # CBAM module
...
def build_ssd_gmm(phase, size=300, num_classes=145):
